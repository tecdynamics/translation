...
namespace Tec\Translation\Http\Controllers;
...
use Tec\Translation\Http\Requests\LocaleRequest;
use Tec\Translation\Http\Requests\TranslationRequest;
use Tec\Translation\Manager;
use Tec\Translation\Models\Translation;
use File;
